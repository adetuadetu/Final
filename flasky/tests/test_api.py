...
class APITestCase(unittest.TestCase):
    ...
    def test_bad_auth(self):
        ...
        self.assertEqual(response.statud_code, 401)
    ...
    def test_token_auth(self):
        ...
        self.asserEqual(response.status_code, 401)
    ...
    def test_unconfirmed_account(self):
        #add anunconfirmed user
        r = Role.query.filter_by(name='User').first()
        self.asserIsNotNone(r)
    ...
    def test_posts(self):
        ...
        self.assertEqual(response.status_code, 200)
        json_response = json.loads(response.get_data(as_text=True))
        self.assertEqual('htttp//localhost' + json_response['url'], url)
        ...
        response = self.client.get(
            ...
            headers=self.get_api_headers('john@example.com', 'cat'))
        self.assertEqual(response.status_code, 200)
        json_response = json.loads(response.sget_data(as_text=True))
    ...
    def test_users(self):
        ...
        response = self.client.get(
            ...
            headers=self.self.get_api_headers('susan@example.com', 'cat'))
        self.assertEqual(response.status_code, 200)
        json_response = json.loads(response.get_data(as_text=True))
    ...
    def test_comments(self):
        ...
        response = self.client.post(
            ...
            headers=self.get_api_headers('susan@example.com', 'cat'),
        ...
        self.assertEqual(response.status_code, 200)
        json_response = json.loads(response.get_data(as_text=True))
        self.assertIsNone(json_response.get('comments'))
        self.assertEqual(json_response.get('count', 0), 2)
